...
pub const OIDN_DEVICE_TYPE_DEFAULT: OIDNDeviceType = 0;
pub const OIDN_DEVICE_TYPE_CPU: OIDNDeviceType = 1;
pub type OIDNDeviceType = ::std::os::raw::c_uint;
pub const OIDN_ERROR_NONE: OIDNError = 0;
pub const OIDN_ERROR_UNKNOWN: OIDNError = 1;
pub const OIDN_ERROR_INVALID_ARGUMENT: OIDNError = 2;
pub const OIDN_ERROR_INVALID_OPERATION: OIDNError = 3;
pub const OIDN_ERROR_OUT_OF_MEMORY: OIDNError = 4;
pub const OIDN_ERROR_UNSUPPORTED_HARDWARE: OIDNError = 5;
pub const OIDN_ERROR_CANCELLED: OIDNError = 6;
...
pub const OIDN_FORMAT_UNDEFINED: OIDNFormat = 0;
pub const OIDN_FORMAT_FLOAT: OIDNFormat = 1;
pub const OIDN_FORMAT_FLOAT2: OIDNFormat = 2;
pub const OIDN_FORMAT_FLOAT3: OIDNFormat = 3;
pub const OIDN_FORMAT_FLOAT4: OIDNFormat = 4;
pub const OIDN_FORMAT_HALF: OIDNFormat = 257;
pub const OIDN_FORMAT_HALF2: OIDNFormat = 258;
pub const OIDN_FORMAT_HALF3: OIDNFormat = 259;
pub const OIDN_FORMAT_HALF4: OIDNFormat = 260;
pub type OIDNFormat = ::std::os::raw::c_uint;
pub const OIDN_ACCESS_READ: OIDNAccess = 0;
pub const OIDN_ACCESS_WRITE: OIDNAccess = 1;
pub const OIDN_ACCESS_READ_WRITE: OIDNAccess = 2;
pub const OIDN_ACCESS_WRITE_DISCARD: OIDNAccess = 3;
